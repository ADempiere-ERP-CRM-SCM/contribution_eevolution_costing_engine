...
--UPDATE AD_Column SET AD_Reference_ID=17, AD_Reference_Value_ID=122, FieldLength=1,Updated=TO_DATE('2010-07-02 15:24:26','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=0 WHERE AD_Column_ID=59584
--;
